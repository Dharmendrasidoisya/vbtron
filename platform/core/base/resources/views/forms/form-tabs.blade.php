            ...
            <x-core::card class="mb-3">
                <x-core::card.header>
                    <x-core::tab class="card-header-tabs">
                        <x-core::tab.item id="tabs-detail" :is-active="true" :label="trans('core/base::tabs.detail')" />
    ...
    <x-core::card class="mb-3">
        ...
        <x-core::card.body>
            @php
                ...
                ->get();
            @endphp
            <x-plugins-ecommerce::box-search-advanced type="product" :search-target="$dataUrl" :shown="$products->isNotEmpty()">
                <input name="related_products" type="hidden"
