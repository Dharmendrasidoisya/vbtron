...
use Botble\Application\Http\Requests\TagRequest;
use Botble\Application\Models\Tag;
use Botble\Application\Tables\TagTable;
...
class TagController extends BaseController
{
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ...
            ->add(trans('plugins/application::tags.menu'), route('applicationtags.index'));
    }

    public function index(TagTable $dataTable)
    {
        $this->pageTitle(trans('plugins/application::tags.menu'));
    ...
    {
        $this->pageTitle(trans('plugins/application::tags.create'));
    ...
    public function store(TagRequest $request)
    {
        ...
        return $this
            ->httpResponse()
            ->setPreviousRoute('applicationtags.index')
            ->setNextRoute('applicationtags.edit', $form->getModel()->getKey())
    ...
    public function getAllapplicationtags()
    {
