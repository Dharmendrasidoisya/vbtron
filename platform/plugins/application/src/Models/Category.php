...
class Category extends BaseModel implements HasTreeCategoryContract
{
    ...
    protected $table = 'applicationcategories';
    ...
    protected static function booted(): void
    {
        static::deleted(function (Category $category) {
            ...
            $category->applicationposts()->detach();
        });
    }

    public function applicationposts(): BelongsToMany
    {
    ...
    public function activeChildrenparent()
    {
    ...
    protected function badgeWithCount(): Attribute
    {
        return Attribute::get(function (): HtmlString {
            return Html::tag('span', sprintf('(%s)', $this->applicationposts_count), [
                'data-bs-toggle' => 'tooltip',
                'data-bs-original-title' => trans('plugins/application::categories.total_applicationposts', ['total' => $this->applicationposts_count]),
            ]);
        });
    }
}
