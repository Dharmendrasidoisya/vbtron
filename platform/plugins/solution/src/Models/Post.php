...
class Post extends BaseModel
{
    ...
    public function stags(): BelongsToMany
    {
        return $this->belongsToMany(Tag::class, 'spost_tags');
    }

    public function scategories(): BelongsToMany
    {
    ...
    protected function firstCategory(): Attribute
    {
        return Attribute::get(function (): ?Category {
            $this->loadMissing('scategories');

            return $this->scategories->first();
        });
    }
    ...
    protected function timeReading(): Attribute
    {
        return Attribute::make(
            get: function (): string|null {
                ...
                return number_format(ceil(str_word_count(strip_stags($this->content)) / 200));
            }
        );
    }
}
