...
class Category extends BaseModel implements HasTreeCategoryContract
{
    ...
    protected static function booted(): void
    {
        static::deleted(function (Category $category) {
            ...
            $category->servicesposts()->detach();
        });
    }

    public function servicesposts(): BelongsToMany
    {
    ...
    protected function badgeWithCount(): Attribute
    {
        return Attribute::get(function (): HtmlString {
            return Html::tag('span', sprintf('(%s)', $this->servicesposts_count), [
                'data-bs-toggle' => 'tooltip',
                'data-bs-original-title' => trans('plugins/services::categories.total_servicesposts', ['total' => $this->servicesposts_count]),
            ]);
        });
    }
}
