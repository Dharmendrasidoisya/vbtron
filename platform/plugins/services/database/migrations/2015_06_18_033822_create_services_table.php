...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('servicestags', function (Blueprint $table) {
            $table->id();
            $table->string('name', 120);
            $table->foreignId('author_id');
            $table->string('author_type', 255)->default(addslashes(User::class));
        ...
        Schema::create('servicesposts', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('servicesposts_tags', function (Blueprint $table) {
            $table->foreignId('tag_id')->index();
            $table->foreignId('post_id')->index();
        });

        Schema::create('servicesposts_categories', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('servicesposts_tags');
        Schema::dropIfExists('servicesposts_categories');
