...
class CategoryRepository extends RepositoriesAbstract implements CategoryInterface
{
    ...
    public function getFeaturedproductscategories(int|null $limit, array $with = []): Collection
    {
        $data = $this->model
    ...
    public function getAllproductscategories(array $condition = [], array $with = []): Collection
    {
    ...
    public function getproductscategories(array $select, array $orderBy, array $conditions = ['status' => BaseStatusEnum::PUBLISHED]): Collection
    {
        $data = $this->model
            ->with('slugable')
            ->select($select);
    ...
    public function getAllproductscategoriesWithChildren(array $condition = [], array $with = [], array $select = ['*']): Collection
    {
        $data = $this->model
            ->where($condition)
            ->with($with)
    ...
    public function getPopularproductscategories(int $limit, array $with = ['slugable'], array $withCount = ['productsposts']): Collection
    {
        $data = $this->model
            ->with($with)
            ->withCount($withCount)
