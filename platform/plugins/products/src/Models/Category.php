...
class Category extends BaseModel implements HasTreeCategoryContract
{
    ...
    protected function badgeWithCount(): Attribute
    {
        return Attribute::get(function (): HtmlString {
            return Html::tag('span', sprintf('(%s)', $this->productsposts_count), [
                'data-bs-toggle' => 'tooltip',
                'data-bs-original-title' => trans('plugins/products::categories.total_productsposts', ['total' => $this->productsposts_count]),
            ]);
        });
    }
}
