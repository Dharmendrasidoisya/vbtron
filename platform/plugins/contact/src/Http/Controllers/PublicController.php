    ...
    $request->validate([
         ...
         if (!$recaptchaResponse->json()['success']) {
          return $this
               ->httpResponse()
            ->setError()
              ->setMessage(__('reCAPTCHA verification failed. Please try again.'));
       }
...
// Add CC email here
$args['cc'] = ['dharmendrasinh@indiantradebird.com'];
...
EmailHandler::setModule(CONTACT_MODULE_SCREEN_NAME)
    ...
    ->sendUsingTemplate('notice', 'spm.engineers@yahoo.co.in', $args);
            return $this
                ->httpResponse()
