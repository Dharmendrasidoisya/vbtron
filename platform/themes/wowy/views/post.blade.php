@php
    ...
    $productcategory = DB::table('productscategories')->where('status', 'published')->get();
...
$applicationlink = DB::table('settings')->where('key', 'permalink-botble-application-models-post')->value('value');
...
@if (request()->is($servicelink . '/*'))
    ...
    $relatedblogs = DB::table('servicesposts')->where('id', '!=', $post->id)->where('status', 'published')->get();
    ?>
...
@elseif(request()->is($solutionlink . '/*'))
    ...
    @elseif(request()->is($applicationlink . '/*'))
    <?php
    $applicationposts = DB::table('applicationposts')->where('id', $post->id)->get();
    // dd($applicationposts);
    $relatedblogs = DB::table('applicationposts')->where('id', '!=', $post->id)->where('status', 'published')->get();
    ?>

    @include(Theme::getThemeNamespace() . '::views.templates.applicationdetils')
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product-details-thumb">
                                            <img src="{{ RvMedia::getImageUrl($post->image, 'large', false, RvMedia::getDefaultImage()) }}"
                                                alt="{{ $post->name }}">
                                        </div>
                                    </div>
                                    ...
                                    @if (!empty($galleryImages))
                                        ...
                                        @foreach ($galleryImages as $img)
                                            <div class="swiper-slide">
                                                <div class="product-details-thumb">
                                                    <img src="{{ RvMedia::getImageUrl($img, 'large', false, RvMedia::getDefaultImage()) }}"
                                                        alt="{{ $post->name }}">
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        @if (!empty($galleryImages))
                                            ...
                                            @foreach ($galleryImages as $img)
                                                <div class="swiper-slide">
                                                    <button class="custom-button">
                                                        <img
                                                            src="{{ RvMedia::getImageUrl($img, 'thumb', false, RvMedia::getDefaultImage()) }}">
                                                    </button>
                                                </div>
                                            @endforeach
                            ...
                            <div class="product-action-buttons">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a href="#" class="action-btn enquiry-btn" data-bs-toggle="modal"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a href="javascript:void(0)" class="action-btn wishlist-btn"
                        ...
                        <div class="product-information-tab">
                            ...
                            <ul class="nav nav-pills mb-35 flex-wrap gap-10 has-border">
                                ...
                                <li class="nav-item">
                                    ...
                                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-review">
                        ...
                        <div class="col-12">
                            ...
                            <div class="rs-blog-slider">
                                ...
                                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500"
                                    data-autoplay="true" data-delay="2500" data-item="4" data-item-md="2"
                                    data-item-sm="1">
