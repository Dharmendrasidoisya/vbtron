            ...
            <div class="col" style="text-align:center;">
                ...
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
                    <ul class="breadcrumb d-flex text-3-5 font-weight-semi-bold pb-2 mb-3">
                        <li><a href="http://127.0.0.1:8000/" class="text-light text-decoration-none">Home</a></li>
                        <li class="active text-color-light opacity-7">About Us</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row align-items-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
            ...
            <div class="appear-animation animated fadeInUpShorter appear-animation-visible"
                ...
                @if ($headertitle)
                    <h2 class="text-9 text-lg-12 font-weight-semibold line-height-1 mb-4">{!! BaseHelper::clean($headertitle) !!}</h2>
                @endif
            </div>
            <div class="appear-animation animated fadeInUpShorter appear-animation-visible"
        ...
        <div class="col-lg-6 p-relative">
            <div class="accordion accordion-modern-status accordion-modern-status-arrow accordion-modern-status-arrow-dark mb-4 my-lg-4 pb-3 pb-lg-0"
                id="accordionWhoWeAre">
                @if (!empty($icon))
                    <img src="{{ RvMedia::getImageUrl(BaseHelper::clean($icon)) }}" loading="lazy" class="img-fluid" alt="icon">
                @else
