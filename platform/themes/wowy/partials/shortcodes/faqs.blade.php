...
<section class="rs-faq-area rs-faq-two section-space" style="display: none;">
    <div class="container">
       ...
       <!-- why choose area start -->
        <section class="rs-why-choose-area section-space rs-why-choose-one has-theme-green">

            <div class="rs-why-choose-shape-one">
                <img src="assets/images/shape/circle-shape-three.png" loading="lazy" alt="image">
            </div>
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-why-choose-content-wrapper">
                            ...
                            <div class="rs-why-choose-item-wrapper">
                                <div class="rs-why-choose-item wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <div class="rs-why-choose-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="39"
                                            ...
                                            <path
                                                ...
                                                stroke="#00a0e3" stroke-width="1.7" stroke-miterlimit="10"
                                            ...
                                            <path
                                                ...
                                                stroke="#00a0e3" stroke-width="1.7" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M18.4194 35.0323H1V1H51V35.0323H33.5806" stroke="#00a0e3"
                                            ...
                                            <path
                                                ...
                                                stroke="#00a0e3" stroke-width="1.7" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M10.2754 9.95117H41.727" stroke="#00a0e3" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M41.7259 12.8535H32.3711" stroke="#00a0e3" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M19.6302 12.8535H10.2754" stroke="#00a0e3" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M39.0663 15.8379H35.1953" stroke="#00a0e3" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M16.8065 15.8379H12.9355" stroke="#00a0e3" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                        </svg>
                                    </div>
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Industry Insight </h5>
                                        <p>To better serve our customers, we actively participate in international
                                            exhibitions and trade fairs, enabling us to understand industry trends,
                                            customer needs, and emerging technologies.</p>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item wow fadeInUp" data-wow-delay=".5s"
                                    data-wow-duration="1s">
                                    <div class="rs-why-choose-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="44"
                                            ...
                                            <path
                                                ...
                                                stroke="#00a0e3" stroke-width="2"></path>
                                        </svg>
                                    </div>
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Global Leadership</h5>
                                        <p>VAPL is among the leading Indian automation companies with a strong global
                                            presence, showcasing innovative smart metering and industrial automation
                                            solutions worldwide.</p>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item wow fadeInUp" data-wow-delay=".7s"
                                    data-wow-duration="1s">
                                    <div class="rs-why-choose-icon">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Technology Agility</h5>
                                        <p>We quickly adapt to new technologies and evolving market requirements,
                                            ensuring our automation products remain efficient, reliable, and
                                            future-ready.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="rs-why-choose-btn" style="display: none;">
                                <a class="rs-btn has-theme-light-green has-icon has-bg" href="#">
                                    Upcoming Events
                                    <span class="icon-box">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-contact-form rs-contact-one has-theme-green-two wow fadeInRight"
                        ...
                        <form>
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="rs-contact-input">
                                        <input id="info" name="name" type="text" placeholder="Your Phone No">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="rs-contact-input">
                                ...
                                <div class="col-md-12">
                                    <div class="rs-contact-btn">
                                        <button type="button" class="rs-btn has-theme-light-green">Send
                                            Message</button>
                                    </div>
                                </div>
                            </div>
