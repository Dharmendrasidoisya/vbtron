...
app()->booted(function () {
    ...
    if (is_plugin_active('services')) {
        ...
        add_shortcode(
            ...
            function (Shortcode $shortcode) {
                $services = get_featured_services_posts(array_merge([
                    'take' => (int)$shortcode->limit ?: 50,
                ], ));
    ...
    __('Ads Productcategory'),
    function (Shortcode $shortcode) {
        $productcategory = get_featured_products_categories(array_merge([
            'take' => (int)$shortcode->limit ?: 50,
            'order_by' => 'id',
            'order' => 'desc',
        ]));
...
shortcode()->setAdminConfig('Ads-productcategory', function (array $attributes) {
    ...
    // if (is_plugin_active('services')) {
        ...
        add_shortcode(
            ...
            function (Shortcode $shortcode) {
                $productcategory = get_featured_services_posts(array_merge([
                    'take' => (int)$shortcode->limit ?: 50,
                ], ));
  ...
  add_shortcode(
            'Ads-home-application',
            __('Ads Home application'),
            __('Ads Home application'),
            function (Shortcode $shortcode) {
                return Theme::partial('shortcodes.Ads-home-application', [
                    'title' => $shortcode->title,
                    'description' => $shortcode->description, 
                    'description2' => $shortcode->description2, 
                    'description3' => $shortcode->description3, 
        ...
        shortcode()->setAdminConfig('Ads-home-application', function (array $attributes) {
            return Theme::partial('shortcodes.Ads-home-application-admin-config', compact('attributes'));
        });
