...
if (! function_exists('get_services_single_layouts')) {
    function get_services_single_layouts(): array
    {
        return [
            '' => __('Inherit'),
            'services-right-sidebar' => __('Services Right Sidebar'),
            'services-left-sidebar' => __('Services Left Sidebar'),
            'services-full-width' => __('Full width'),
        ];
    }
}
